...
import com.example.diplomatest.databinding.ActivityWritingEditResultsBinding
...
class WritingEditResultsActivity: AppCompatActivity() {
    private lateinit var binding: ActivityWritingEditResultsBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityWritingEditResultsBinding.inflate(layoutInflater)
    ...
    private fun fetchExistingAnswers(id: String) {
        mDataBase.collection("WritingTestsAnswers").document(id).get()
    ...
    fun editTest(id: String) {
        var storageRef = storage.reference.child("WritingTestsAnswers")
