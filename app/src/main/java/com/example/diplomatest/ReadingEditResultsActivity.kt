...
import com.example.diplomatest.databinding.ActivityReadingEditResultsBinding
...
class ReadingEditResultsActivity: AppCompatActivity() {
    private lateinit var binding: ActivityReadingEditResultsBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityReadingEditResultsBinding.inflate(layoutInflater)
...
//        }
    ...
    private fun fetchAndPopulateData(id: String) {
        ...
        mDataBase.collection("ReadingTestsAnswers")
            ...
            .addOnSuccessListener { documentSnapshot ->
                val data = documentSnapshot.toObject(ReadingTest::class.java)
                data?.let {
                    et1.setText(it.q1)
                    et2.setText(it.q2)
                    et3.setText(it.q3)
    ...
    fun editApartment(id: String) {
        var storageRef = storage.reference.child("ReadingTestsAnswers")
