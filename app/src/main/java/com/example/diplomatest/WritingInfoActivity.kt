...
import com.example.diplomatest.databinding.ActivityWritingInfoBinding
import com.example.diplomatest.model.WritingTest
import com.google.firebase.firestore.FirebaseFirestore
import com.squareup.picasso.Callback
import com.squareup.picasso.Picasso

class WritingInfoActivity: AppCompatActivity() {
    private lateinit var binding: ActivityWritingInfoBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityWritingInfoBinding.inflate(layoutInflater)
...
//        }
    ...
    fun deleteBtn(id: String){
        ...
        mDataBase.collection("WritingTests").document(id).delete()
