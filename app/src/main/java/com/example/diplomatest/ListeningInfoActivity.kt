...
import com.example.diplomatest.databinding.ActivityListeningInfoBinding
import com.example.diplomatest.model.ListeningTest
import com.google.firebase.firestore.FirebaseFirestore
import com.squareup.picasso.Callback
import com.squareup.picasso.Picasso

class ListeningInfoActivity : AppCompatActivity() {
    private lateinit var binding: ActivityListeningInfoBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityListeningInfoBinding.inflate(layoutInflater)
...
//        questions.forEachIndexed { index, question -> questionTextViews[index].setText(question) }
    ...
    private fun editBtn(id: String) {
        finish()
        val intent = Intent(this, ListeningEditActivity::class.java)
