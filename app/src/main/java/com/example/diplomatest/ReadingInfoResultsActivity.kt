...
import com.example.diplomatest.databinding.ActivityReadingInfoResultsBinding
import com.example.diplomatest.model.ReadingTest
import com.google.firebase.firestore.FirebaseFirestore
import com.squareup.picasso.Callback
import com.squareup.picasso.Picasso

class ReadingInfoResultsActivity: AppCompatActivity() {
    private lateinit var binding: ActivityReadingInfoResultsBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityReadingInfoResultsBinding.inflate(layoutInflater)
...
//        }
    ...
    fun deleteBtn(id: String){
        ...
        mDataBase.collection("ReadingTestsAnswers").document(id).delete()
    ...
    fun editBtn(id: String){
        val intent = Intent(this, ReadingEditResultsActivity::class.java)
