...
import com.example.diplomatest.databinding.ActivityListeningEditBinding
import com.example.diplomatest.model.ListeningTest
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.firestore.FirebaseFirestore
import com.google.firebase.storage.FirebaseStorage

class ListeningEditActivity: AppCompatActivity() {
    private lateinit var binding: ActivityListeningEditBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityListeningEditBinding.inflate(layoutInflater)
...
//        }
    ...
    fun editApartment(id: String) {
        var storageRef = storage.reference.child("ListeningTests")
                ...
                if (uri != null) {
                    storageRef.putFile(uri!!)
                        .addOnSuccessListener {
                            saveOrUpdateListeningTest(id, username, currentUserID)
                        }
    ...
    private fun saveOrUpdateListeningTest(id: String, username: String, currentUserID: String) {
        ...
        val firestore = FirebaseFirestore.getInstance()
        firestore.collection("ListeningTests")
            .document(id)
            .get()
            .addOnSuccessListener { documentSnapshot ->
                ...
                // Check if document already exists in ListeningTestsAnswers
                firestore.collection("ListeningTestsAnswers")
                    ...
                    .addOnFailureListener { e ->
                        Toast.makeText(this, "Error checking existing answers: ${e.message}", Toast.LENGTH_SHORT).show()
                    }
            }
            .addOnFailureListener { e ->
                Toast.makeText(this, "Error fetching ListeningTest: ${e.message}", Toast.LENGTH_SHORT).show()
            }
    }
