...
import com.example.diplomatest.ReadingInfoActivity
...
class ReadingTestAdapter(
    var c: Context, var readinglist:ArrayList<ReadingTest>
): RecyclerView.Adapter<ReadingTestAdapter.TestViewHolder>()
{
    ...
    override fun onBindViewHolder(holder: TestViewHolder, position: Int) {
        ...
        holder.v.root.setOnClickListener{
            val intent = Intent(c, ReadingInfoActivity::class.java)
