...
): RecyclerView.Adapter<WritingTestResultsAdapter.TestViewHolder>()
{
    ...
    override fun onBindViewHolder(holder: TestViewHolder, position: Int) {
        ...
        holder.v.root.setOnClickListener{
            val intent = Intent(c, WritingInfoResultsActivity::class.java)
