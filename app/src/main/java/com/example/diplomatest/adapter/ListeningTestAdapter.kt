...
): RecyclerView.Adapter<ListeningTestAdapter.TestViewHolder>()
{
    ...
    override fun onBindViewHolder(holder: TestViewHolder, position: Int) {
        ...
        holder.v.root.setOnClickListener{
            val intent = Intent(c, ListeningInfoActivity::class.java)
